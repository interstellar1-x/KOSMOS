...
function initThree() {
    ...
    scene.fog = new THREE.FogExp2(0x5a3d9a, 0.00003);

    // Load nebula background
    const textureLoader = new THREE.TextureLoader();
    scene.background = textureLoader.load('../resources/nebula.png');
    ...
    // orbit controls for smooth 3D rotation
...
function initRenderPipeline() {
    ...
    baseComposer.renderToScreen = true
