...
/**
 * Factory function to create Venus scene in a container
 * @param {HTMLElement} container - DOM element to render into
 * @returns {Object} { scene, camera, renderer, controls, dispose, meshes }
 */
export async function initVenusScene(container) {
  ...
  venusGroup.rotation.z = (-25.19 * Math.PI) / 180;
  ...
  const venusTex = await loadTextureAsync(loader, VENUS_SURFACE);
  ...
  return {
    ...
    controls,
    dispose,
    meshes: { venusMesh, glowMesh, stars },
  };
}
