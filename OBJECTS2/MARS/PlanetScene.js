...
/**
 * Factory function to create Mars scene in a container
 * @param {HTMLElement} container - DOM element to render into
 * @returns {Object} { scene, camera, renderer, controls, animate, dispose }
 */
export async function initMarsScene(container) {
  ...
  const marsTex = await loadTextureAsync(loader, MARS_SURFACE);
  ...
  return {
    ...
    controls,
    dispose,
    meshes: { marsMesh, glowMesh, stars },
  };
}
