...
const URANUS_SURFACE = "./uranus.jpg";
...
/**
 * Factory function to create Uranus scene in a container
 * @param {HTMLElement} container - DOM element to render into
 * @returns {Object} { scene, camera, renderer, controls, dispose, meshes }
 */
export async function initUranusScene(container) {
  ...
  uranusGroup.rotation.z = (-25.19 * Math.PI) / 180;
  ...
  const uranusTex = await loadTextureAsync(loader, URANUS_SURFACE);
  ...
  return {
    ...
    controls,
    dispose,
    meshes: { uranusMesh, glowMesh, stars },
  };
}
