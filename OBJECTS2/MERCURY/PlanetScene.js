...
const MERCURY_SURFACE = "./mercury.jpg";
...
/**
 * Factory function to create Mercury scene in a container
 * @param {HTMLElement} container - DOM element to render into
 * @returns {Object} { scene, camera, renderer, controls, dispose, meshes }
 */
export async function initMercuryScene(container) {
  ...
  mercuryGroup.rotation.z = (-25.19 * Math.PI) / 180;
  ...
  const mercuryTex = await loadTextureAsync(loader, MERCURY_SURFACE);
  ...
  return {
    ...
    controls,
    dispose,
    meshes: { mercuryMesh, glowMesh, stars },
  };
}
