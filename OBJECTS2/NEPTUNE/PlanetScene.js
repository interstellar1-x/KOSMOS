...
/**
 * Factory function to create Neptune scene in a container
 * @param {HTMLElement} container - DOM element to render into
 * @returns {Object} { scene, camera, renderer, controls, dispose, meshes }
 */
export async function initNeptuneScene(container) {
  ...
  const neptuneTex = await loadTextureAsync(loader, NEPTUNE_SURFACE);
  ...
  return {
    ...
    controls,
    dispose,
    meshes: { neptuneMesh, glowMesh, stars },
  };
}
