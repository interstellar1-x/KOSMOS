...
/**
 * Factory function to create Moon scene in a container
 * @param {HTMLElement} container - DOM element to render into
 * @returns {Object} { scene, camera, renderer, controls, dispose, meshes }
 */
export async function initMoonScene(container) {
  ...
  moonGroup.rotation.z = (-25.19 * Math.PI) / 180;
  scene.add(moonGroup);
  ...
  const moonTex = await loadTextureAsync(loader, MOON_SURFACE);
  ...
  return {
    ...
    controls,
    dispose,
    meshes: { moonMesh, glowMesh, stars },
  };
}
